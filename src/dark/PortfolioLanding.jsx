      ...
      <div id="home" className="fix">
        <div className="slider-wrapper">
          ...
          {SlideList.map((value, index) => (
            <div
              className="slide personal-portfolio-slider slider-paralax slider-style-3 d-flex align-items-center justify-content-center bg_image bg_image--37"
              key={index}
            >
              ...
              <div className="row row--35 align-items-center">
                <div className="col-lg-5">
                  <div className="thumbnail">
                    <img
                      className="w-100"
                      src="/assets/images/about/about-14.jpg"
                      alt="About Images"
                    />
                  </div>
                </div>
            ...
            <div className="row">
              <div className="col-lg-12">
                <div className="section-title text-center service-style--3 mb--30 mb_sm--0">
                  ...
                  <h5>Endeavor is the fundamental to success</h5>
                  <p>
          ...
          <div className="portfolio-sacousel-inner">
            <div className="container">
              <div className="row">
                <div className="col-lg-12">
                  <div className="section-title text-center service-style--3 mb--30 mb_sm--0">
                    <h2 className="title">Passions and Enthusiasms</h2>
                    <h5>How I savor leasure time</h5>
                    <p>
                      A man's prime interest in life must NOT only be his work
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="row align-items-end">
              <div className="col-lg-12 col-md-12 col-sm-12 col-12">
                <div className="section-title text-center">
                  ...
                  <p>"Goals are dreams with deadlines." ~ Diana Scharf </p>
                  <br />
                  <h5>but at least, dreams come true!</h5>
                </div>
              </div>
            </div>
      ...
      <div id="contact" className="fix">
        <div className="rn-contact-area ptb--120 bg_color--1">
          <ContactThree
            ...
            contactTitle="Business Inqueries"
          />
        </div>
      </div>
      {/* End COntact Area */}
